...
f=plot(f1,f2,f3,f4, layout=(2,2), size=(1000,800))
savefig("./docs/src/assets/lasers_ellip.svg")
...
f=plot(f1,f2,f3,f4, layout=(2,2), size=(1000,800))
savefig("./docs/src/assets/lasers_azimuth.svg")
...
f=plot!(xlabel=raw"$t$/a.u.", ylabel=raw"$f_\mathrm{env}$", xlim=(-300,300), ylim=(-1.05,1.05), size=(500,400), framestyle=:box)
savefig("./docs/src/assets/lasers_cep.svg")
...
plot!(xlabel=raw"$t$/a.u.", ylabel=raw"$f^{\ cos4}_\mathrm{env}$", xlim=(-600,600), ylim=(-1.05,1.05), legend=:none, size=(500,400), framestyle=:box)
annotate!(t[1], 1.0, text(" Cos4Laser", :black, :top, :left, 20))
annotate!(t[end], 1.0, text("800 nm  \n10 cycs  ", :black, :top, :right, 12))
savefig("./docs/src/assets/lasers_env_cos4.svg")
...
plot!(t, -1 .* UnitEnvelope(l).(t), color=:gray, fill=0, α=0.2)
plot!(t, LaserAx(l).(t) ./ LaserA0(l), color=RGB(0/255,154/255,250/255))
plot!(xlabel=raw"$t$/a.u.", ylabel=raw"$f^{\ cos2}_\mathrm{env}$", xlim=(-600,600), ylim=(-1.05,1.05), legend=:none, size=(500,400), framestyle=:box)
annotate!(t[1], 1.0, text(" Cos2Laser", :black, :top, :left, 20))
annotate!(t[end], 1.0, text("800 nm  \n10 cycs  ", :black, :top, :right, 12))
savefig("./docs/src/assets/lasers_env_cos2.svg")

# =======================

t = -1000:1:1000
l = GaussianLaser(peak_int=1e14, wave_len=800.0, FWHM_duration=550, ellip=0)
plot(t, UnitEnvelope(l).(t), color=:gray, fill=0, α=0.2)
plot!(t, -1 .* UnitEnvelope(l).(t), color=:gray, fill=0, α=0.2)
plot!(t, LaserAx(l).(t) ./ LaserA0(l), color=RGB(0/255,154/255,250/255))
plot!(xlabel=raw"$t$/a.u.", ylabel=raw"$f^{\ Gauss.}_\mathrm{env}$", xlim=(-1000,1000), ylim=(-1.05,1.05), legend=:none, size=(500,400), framestyle=:box)
annotate!(t[1], 1.0, text(" GaussianLaser", :black, :top, :left, 16))
annotate!(t[end], 1.0, text("800 nm  \nFWHM 5 cycs  ", :black, :top, :right, 12))
savefig("./docs/src/assets/lasers_env_gaussian.svg")
